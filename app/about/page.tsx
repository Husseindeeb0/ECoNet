...
import { Code2, GraduationCap, Rocket, Heart, Globe, Users, Calendar, Building2, Linkedin } from "lucide-react";
                    ...
                    <div className="mx-auto max-w-2xl text-center">
                        <AnimatedPageHeader>
                            ...
                            <p className="mt-6 text-lg leading-8 text-slate-600">
                                ...
                                EventHub is dedicated to helping university students discover, book, and manage events seamlessly.
                                We bridge the gap between campus life and professional opportunities.
                            </p>
                            <p className="mt-4 text-lg leading-8 text-slate-600">
                                Whether you are looking to join a hackathon, attend a workshop, or organize a club meeting,
                                EventHub provides the tools and community you need to succeed. Join us in shaping the future of campus experiences.
                            </p>
                        </AnimatedPageHeader>
                    </div>
                </div>
            ...
            <AnimatedPageContent>
                                ...
                                >
                                    <div className="h-full border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all duration-500 hover:-translate-y-2 bg-white rounded-[2rem] overflow-hidden group p-2">
                                        <div className="h-full p-6 flex flex-col items-center text-center">
                                            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 transition-colors duration-500 ${stat.colorClass}`}>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 py-12 sm:py-16">
                    <div className="mx-auto max-w-2xl lg:text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-slate-600">
                            We believe in the power of community. Our platform is designed to make event management
                            effortless for organizers and event discovery exciting for students.
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-slate-50 py-12 sm:py-16 overflow-hidden">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl lg:text-center mb-10">
                            <h2 className="text-base font-semibold leading-7 text-indigo-600">Official Partnership</h2>
                            <p className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
                            ...
                            >
                                ...
                                <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-24 lg:text-left relative z-10">
                                    <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
                                        Proudly Developed During<br />TechTalks Internship
                                    </h2>
                                    <p className="mt-6 text-lg leading-8 text-indigo-100">
                                        This project is a result of the intensive training and mentorship provided by the
                                        TechTalks Official Internship program, fostering the next generation of tech leaders.
                                    </p>
                ...
                <div className="py-12 sm:py-16">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl lg:text-center mb-10">
                            <h2 className="text-base font-semibold leading-7 text-indigo-600">The Minds Behind EventHub</h2>
                            <p className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
                                Meet the Team
                            </p>
                        </div>
                                    ...
                                    >
                                        <div className="text-center group transition-all duration-300 hover:-translate-y-1 h-full bg-white rounded-2xl p-8 shadow-[0_4px_20px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-100">
                                            <div className="mb-4 inline-flex relative">
                                                <div className={`w-24 h-24 rounded-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-105 ${member.bgClass}`}>
                                                    <member.icon
                ...
                <div className="bg-slate-50 py-12 sm:py-16">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl lg:text-center mb-10">
                            <h2 className="text-base font-semibold leading-7 text-indigo-600">Built With Modern Tech</h2>
                            <p className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
                                    ...
                                    >
                                        <div className="text-center group bg-white rounded-2xl p-8 shadow-[0_4px_20px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-100 hover:-translate-y-1 transition-all duration-300 h-full">
                                            <div className="mb-4 inline-flex">
                                                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 ${tech.bgClass}`}>
                                                    <tech.icon
